...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 16 2023 г., 19:34
...
--
-- Дамп данных таблицы `сборщики`
--

INSERT INTO `сборщики` (`id`, `img_path`, `name`, `id_brigada`, `personal characteristics`, `year of birth`) VALUES
...
--
-- Индексы таблицы `сборщики`
--
ALTER TABLE `сборщики`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT для таблицы `сборщики`
--
ALTER TABLE `сборщики`
